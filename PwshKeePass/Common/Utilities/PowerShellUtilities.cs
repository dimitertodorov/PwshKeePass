...
namespace PwshKeePass.Common.Utilities
{
    public static class PowerShellUtilities
    {
        ...
        public static IEnumerable<RuntimeDefinedParameter> GetUsedDynamicParameters(
            RuntimeDefinedParameterDictionary dynamicParameters, InvocationInfo MyInvocation)
        {
            return dynamicParameters.Values.Where(dp =>
                MyInvocation.BoundParameters.Keys.Any(bp => bp.Equals(dp.Name)));
        }
    }
}